...
contract MyERC1155MintAndBurned is ERC1155,Ownable{
    ...
    //transfer token
    function transfer(address _to,uint _id,uint _tokenAmount) public {
        safeTransferFrom(msg.sender,_to,_id,_tokenAmount,"");
    }
